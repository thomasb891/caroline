...
const Planning = {
  ...
  async render() {
    ...
    workMissions.forEach(m => {
      ...
      const segur = e && e.segur ? e.segur : 0;
      const heures = m.heuresTravaillees || 0;
      const base = heures * (taux + segur) + heures * primeNuit + heures * primeDim;
      totalPrimes += heures * primeNuit + heures * primeDim + heures * segur;
    ...
    page.innerHTML = `
      ...
      <div class="cards-row">
        ...
        <div class="stat-card green">
          ...
          <div class="sub">Base ${salaireBase.toFixed(0)}&euro; (Segur+primes inclus) + IFC ${totalIFC.toFixed(0)}&euro; + CP ${totalCP.toFixed(0)}&euro;</div>
        </div>
